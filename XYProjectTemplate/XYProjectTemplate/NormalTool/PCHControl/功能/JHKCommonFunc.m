...
{
   return [GTMBase64 decodeString:strEncodeData];
}
...
{
    if (string == nil)
        [NSException raise:NSInvalidArgumentException format:@"customExceptionLog"];
    if ([string length] == 0)
        return [NSData data];
