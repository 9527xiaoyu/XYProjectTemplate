//
//  UITextField+JHKUtil.m
//  JinHuKao
//
//  Created by 杨晓宇 on 2020/10/16.
//

#import "UITextField+JHKUtil.h"
...
@implementation UITextField (JHKUtil)
- (void)setTextOffset:(UIOffset)offset
{
    [self setValue:[NSValue value:&offset withObjCType:@encode(UIOffset)] forKey:@"_searchTextOffsetValue"];
}
